...
| **Conditional** | Visibility tier: commitment on chain, value disclosed off chain under an access grant. |
...
| **Private** | Visibility tier: commitment on chain, value never disclosed to counterparties. |
| **Public** | Visibility tier: value on chain in clear. |
...
| **Visibility tier** | Private, conditional or public. Determines the disclosure path, not whether the datapoint is committed. |
